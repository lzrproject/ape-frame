...
//        tableName.add("JHEMR_cda35");
        tableName.add("JHEMR_cda36");
        tableName.add("JHEMR_cda37");
        tableName.add("JHEMR_cda38");
        tableName.add("JHEMR_cda39");
        tableName.add("JHEMR_cda40");
        tableName.add("JHEMR_cda41");
        tableName.add("JHEMR_cda42");
        tableName.add("JHEMR_cda43");
        tableName.add("JHEMR_cda44");
        tableName.add("JHEMR_cda45");
        tableName.add("JHEMR_cda46");
        tableName.add("JHEMR_cda47");
        tableName.add("JHEMR_cda48");
        tableName.add("JHEMR_cda49");
        tableName.add("JHEMR_cda50");
        tableName.add("JHEMR_cda51");
        tableName.add("JHEMR_cda53");

//        tableName.add("JHDL_15_EMRINSTANCE.INSTANCEDATA");
